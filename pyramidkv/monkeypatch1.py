...
def replace_llama(method, model_name=None):
    ...
    if method == "pyramidkv":
        ...
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_PyramidKV
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_PyramidKV
        ...
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_StreamingLLM
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_StreamingLLM
        
    elif method == "h2o":
        print("Using H2O!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_H2O
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_H2O
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_H2O
    
    elif method == "cam":
        print("Using CAM!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_CAM
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_CAM
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_CAM
        
    elif method == "snapkv":
        print("Using SnapKV!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_SnapKV
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_SnapKV
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_SnapKV
        ...
        transformers.integrations.flash_attention.flash_attention_forward = minference_attn_forward
        transformers.integrations.sdpa_attention.sdpa_attention_forward = minference_attn_forward
        
    elif method == "l2norm":
        print("Using L2Norm!")
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_L2Norm
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_L2Norm
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_sdpa_attn_forward_L2Norm
        ...
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_AdaKV
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_flash_attn2_forward_AdaKV

    elif method == "headkv":
        print("Using HeadKV!")
        transformers.models.llama.modeling_llama.LlamaModel.forward = adaptive_LlamaModel_forward
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_flash_attn2_forward_HeadKV
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_HeadKV
        transformers.integrations.sdpa_attention.sdpa_attention_forward = llama_flash_attn2_forward_HeadKV
        ...
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_SnapKV_ThinK
        ...
        transformers.integrations.flash_attention.flash_attention_forward = llama_flash_attn2_forward_SnapKV_AdaThinK
