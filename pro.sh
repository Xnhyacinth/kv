...
ins=(28000 20000 16000 8000 2000)
outs=(32 100 338)
...
# bash scripts/scripts_longBench/eval.sh 0 FullKV > logs/FullKV.log

# bash scripts/scripts_longBench/eval.sh 0 SnapKV 0.5 128 > logs/SnapKV_0.5_128.log

# bash scripts/scripts_longBench/eval.sh 0 ThinK 0.5 128 > logs/ThinK_0.5_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.8 512 > logs/AdaThinK_0.8_512.log

# # bash scripts/scripts_longBench/eval.sh 0 ThinK 0.8 128 > logs/ThinK_0.8_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.8 128 > logs/AdaThinK_0.8_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.7 128 > logs/AdaThinK_0.7_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.6 128 > logs/AdaThinK_0.6_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.5 128 > logs/AdaThinK_0.5_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.4 128 > logs/AdaThinK_0.4_128.log

# # bash scripts/scripts_longBench/eval.sh 0 ThinK 0.7 128 > logs/ThinK_0.7_128.log

# # bash scripts/scripts_longBench/eval.sh 0 ThinK 0.6 128 > logs/ThinK_0.6_128.log

# # bash scripts/scripts_longBench/eval.sh 0 ThinK 0.5 128 > logs/ThinK_0.5_128.log

# # bash scripts/scripts_longBench/eval.sh 0 ThinK 0.4 128 > logs/ThinK_0.4_128.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.7 512 > logs/AdaThinK_0.7_512.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.6 512 > logs/AdaThinK_0.6_512.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.5 512 > logs/AdaThinK_0.5_512.log

# bash scripts/scripts_longBench/eval.sh 0 AdaThinK 0.4 512 > logs/AdaThinK_0.4_512.log
...
# bash scripts/scripts_longBench/eval.sh 6,7 AdaThinK